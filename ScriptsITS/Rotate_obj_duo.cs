...
public class Rotate_obj_duo : MonoBehaviour {
	...
	{	
		obj_deselect.GetComponent<Rotate_obj_duo>().select = 0;
		select = 1;
	}
 	void Update()
	{
		if(data.GetComponent<WinConDuo>().finish == 0 && select == 1 && data2.GetComponent<PausePannel>().visible == 0)
		{
